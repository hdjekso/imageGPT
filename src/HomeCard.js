...
const HomeCard = ({msgID}) => {
    ...
    const fetchData = async () => {
        ...
        console.log("concatenated url: " + `http://127.0.0.1:5000/conversations/retrieve/all/${local_token}/${msgID}`);
        fetch(`http://127.0.0.1:5000/conversations/retrieve/all/${msgID}`)
